...
public class ProdutoService {
	...
	public String funcaoReduce(){
		List<Produto> list = repositorio.findAllProduto();

		Double somaPreco = list.stream().map(Produto::getPreco).reduce(0.0,(acumulador, elemento) -> acumulador + elemento);

		return "A soma dos preços é: " + somaPreco;
	}
}
